...
Finally we obtain 2000 images for each shape, and we split them into \textbf{training set}, \textbf{development set} and \textbf{test set} with a $8:1:1$ ratio.  The images look like this. (Figure 1)
